...
{
    public class EnemyMoveToStartPositionState : StateMachineBehaviour
    {
        ...
        {
            var movementAxisX = 0;
            if (_rigidbody2D.position.x > _controller.startPosition.x) movementAxisX = -1;
            else if (_rigidbody2D.position.x < _controller.startPosition.x) movementAxisX = 1;
